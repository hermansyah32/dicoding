...
public class MovieFavoriteFragmentTest {
    ...
    private MovieFavoriteFragment movieFavoriteFragment = new MovieFavoriteFragment();
    ...
    public void loadData() {
        onView(withId(R.id.recyclerViewMovie)).check(new RecyelerViewItemCountAssertion(6));
    }
}