...
import com.manheadblog.moviecatalogue.data.NetworkBoundResource;
import com.manheadblog.moviecatalogue.data.RepositoryData;
import com.manheadblog.moviecatalogue.data.RepositoryInterface;
...
public class FakeRepositoryData implements RepositoryInterface{

    private volatile static FakeRepositoryData instance = null;
    private final RemoteRepository remoteRepository;
    private final LocalRepository localRepository;
    private  final AppExecutors appExecutors;

    FakeRepositoryData(@NonNull LocalRepository localRepository, @NonNull RemoteRepository remoteRepository, AppExecutors appExecutors){
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
        this.appExecutors = appExecutors;
    }

    public static FakeRepositoryData getInstance(LocalRepository localRepository, RemoteRepository remoteRepository, AppExecutors appExecutors){
        if (instance == null){
            synchronized (RepositoryData.class){
                if (instance == null){
                    instance = new FakeRepositoryData(localRepository, remoteRepository, appExecutors);
                }
            }
        }
        return instance;
