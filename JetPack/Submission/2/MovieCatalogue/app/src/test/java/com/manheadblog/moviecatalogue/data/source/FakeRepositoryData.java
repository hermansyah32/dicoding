...
public class FakeRepositoryData implements RepositoryInterface{
    ...
    FakeRepositoryData(@NonNull RemoteRepository remoteRepository){
        this.remoteRepository = remoteRepository;
    }

    public static FakeRepositoryData getInstance(RemoteRepository remoteRepository){
        if (instance == null){
            synchronized (FakeRepositoryData.class){
                if (instance == null){
                    instance = new FakeRepositoryData(remoteRepository);
                }
            }
        }
        return instance;
