...
public class TVShowsFragmentViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<TVShow>> favtvshowList = new MutableLiveData<>();
    ...
    LiveData<ArrayList<TVShow>> getLocalTVShows() {
    ...
    LiveData<ArrayList<TVShow>> setData(int current_page) {
        ...
        favtvshowList.postValue(TVShowMappingHelper.mapCursorToArrayList(App.getInstance().getContentResolver().query(CONTENT_URI_TVSHOW, null, null, null, null)));
