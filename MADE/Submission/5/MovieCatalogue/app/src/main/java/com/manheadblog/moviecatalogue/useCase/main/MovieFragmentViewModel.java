...
public class MovieFragmentViewModel extends ViewModel {
    ...
    LiveData<ArrayList<Movie>> setData(int current_page) {
        ...
        favoritemovieList.postValue(MovieMappingHelper.mapCursorToArrayList(App.getInstance().getApplicationContext().getContentResolver().query(CONTENT_URI_MOVIE, null, null, null, null)));
