...
import com.manheadblog.moviecatalogue.databinding.MovieSearchFragmentBinding;
...
public class MovieSearchFragment extends Fragment implements MoviesAdapter.OnItemClickCallaback, View.OnClickListener{
    ...
    public MovieSearchViewModel viewModel;
    private MoviesAdapter moviesAdapter;
    private MovieHelper movieHelper;
    private MovieSearchFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.movie_search_fragment, container, false);
