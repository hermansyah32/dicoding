...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder holder, final int position) {
        ...
        if (movie.getPosterPath()!=null){
            ...
            holder.imageViewPoster.setImageDrawable(App.getInstance().getResources().getDrawable(R.drawable.ic_image_black_24dp));
        }
        ...
        if (movie.getIsLiked()){
            ...
            holder.imageViewLike.setImageDrawable(App.getInstance().getResources().getDrawable(R.drawable.ic_favorite_border_black_24dp));
        }
