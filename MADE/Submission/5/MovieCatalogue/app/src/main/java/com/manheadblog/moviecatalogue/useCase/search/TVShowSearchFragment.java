...
import com.manheadblog.moviecatalogue.databinding.TvshowSearchFragmentBinding;
...
public class TVShowSearchFragment extends Fragment implements TVShowAdapter.OnItemClickCallaback, View.OnClickListener {
    ...
    public TvShowSearchViewModel viewModel;
    private TVShowAdapter tvShowAdapter;
    private TVShowHelper tvShowHelper;
    private TvshowSearchFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.tvshow_search_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this).get(TvShowSearchViewModel.class);
