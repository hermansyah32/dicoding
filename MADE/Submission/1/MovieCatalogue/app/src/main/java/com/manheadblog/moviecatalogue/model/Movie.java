...
public class Movie implements Parcelable {
    private String title, description, crews, status, release_information,
    ...
    public String getReleaseDate() {
        String[] arrayString = this.release_information.split(";");
        String[] releaseInformation = arrayString[0].split(":");
        return releaseInformation[2];
    }
