...
public class Movie implements Parcelable {
    ...
    public String getStringRuntime(){
        ...
        if (runtime<1){
            ...
            result = minute +
                    App.getContext().getResources().getString(R.string.minute);
        }else {
            result = hour +
                    App.getContext().getResources().getString(R.string.hour) + " " +
                    minute +
                    App.getContext().getResources().getString(R.string.minute);
        }
        return result;
    ...
    public String getVoteAverageColor(){
        if (voteAverage >= 7) {
            return "#" + Integer.toHexString(ContextCompat.getColor(App.getContext(), R.color.score_green));
        } else if (voteAverage < 7 && voteAverage > 5) {
            return "#" + Integer.toHexString(ContextCompat.getColor(App.getContext(),R.color.score_yellow));
        } else {
            return "#" + Integer.toHexString(ContextCompat.getColor(App.getContext(),R.color.score_red));
        }
    }
