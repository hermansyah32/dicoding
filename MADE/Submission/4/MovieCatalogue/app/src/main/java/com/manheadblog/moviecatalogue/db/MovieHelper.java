...
public class MovieHelper {
    ...
    public static MovieHelper getInstance(){
        if (INSTANCE == null){
            synchronized (SQLiteOpenHelper.class){
                if (INSTANCE == null){
                    INSTANCE = new MovieHelper(App.getContext());
                }
            }
        }
        return INSTANCE;
    ...
    public ArrayList<Movie> getAll(){
        ...
        if (cursor.getCount()>0){
            do {
                movie = new Movie();
                movie.setDatabase_id(cursor.getInt(cursor.getColumnIndexOrThrow(_ID)));
                movie.setTitle(cursor.getString(cursor.getColumnIndexOrThrow(DatabaseContract.MovieColumn.TITLE)));
                movie.setId(cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseContract.MovieColumn.ITEM_ID)));
                ...
                movie.setBudget(cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseContract.MovieColumn.BUDGET)));
                movie.setRevenue(cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseContract.MovieColumn.REVENUE)));
    ...
    public long insert(Movie movie){
        ...
        contentValues.put(DatabaseContract.MovieColumn.ITEM_ID, movie.getId());
