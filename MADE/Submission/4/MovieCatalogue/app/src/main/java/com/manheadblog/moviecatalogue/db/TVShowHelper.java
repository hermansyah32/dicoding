...
public class TVShowHelper {
    ...
    public static TVShowHelper getInstance(){
        if (INSTANCE == null){
            synchronized (SQLiteOpenHelper.class){
                if (INSTANCE == null){
                    INSTANCE = new TVShowHelper(App.getContext());
                }
            }
        }
        return INSTANCE;
    ...
    public ArrayList<TVShow> getAll(){
        ...
        if (cursor.getCount()>0){
            do {
                tvshow = new TVShow();
                tvshow.setDatabase_id(cursor.getInt(cursor.getColumnIndexOrThrow(_ID)));
                tvshow.setName(cursor.getString(cursor.getColumnIndexOrThrow(DatabaseContract.TVShowColumn.NAME)));
                tvshow.setId(cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseContract.TVShowColumn.ITEM_ID)));
    ...
    public long insert(TVShow tvshow){
        ...
        contentValues.put(DatabaseContract.TVShowColumn.ITEM_ID, tvshow.getId());
